...
namespace D2.Model.Tests
{
    ...
    public class PlayerCharacterTests
    {
        ...
        public void WhenWeLoad_SaveGameFromFile_WeAssertAllAttributes()
        {
            ...
            // Act
            var actual = new SaveGame(this.saveGameContent,this.parser, changedDate).GetPlayerCharacter();
        ...
        public void GetRasanStats()
        {
            ...
            var actual = new SaveGame(this.rasanSaveGameContent, this.parser, changedDate).GetPlayerCharacter();
        ...
        public void GetSubstringStartingWithAsciiGF_WhenSaveGameProvided_WeAssertWeGetGFUntilEndSubstring()
        {
            ...
            var saveGame = new SaveGame(this.craftedSaveGameContent, this.parser, changedDate);
        ...
        public void GetName_WhenTestGameProvided_WeAssertNameOfCharacter()
        {
            // Arrange
            var changedDate = new DateTime(2020,03,22);
            var saveGame = new SaveGame(this.saveGameContent, this.parser, changedDate);
