namespace D2.Model
{
    public class Parser : IParser
    {
        ...
        public Dictionary<string, bool[]> GetParsedValuesFrom(bool[] input, ParserToken[] parserTokens)
        {
        ...
        public Dictionary<string, string> ParseGfValuesFromText(string inputText)
        {
